...
export const copy = {
  zh: {
    ...
    footerOne: '麦麦 · 个人交易笔记与历史复盘', footerTwo: '期权可能归零 · 不构成投资建议', pageViews: '浏览次数', footerX: 'X · 更新', footerGithub: 'GitHub · 纠错', footerNav: '更新与纠错',
  ...
  en: {
    ...
    footerOne: 'Maimai · Personal trading notes and historical reviews', footerTwo: 'Options can expire worthless · Not investment advice', pageViews: 'Page views', footerX: 'X · Updates', footerGithub: 'GitHub · Corrections', footerNav: 'Updates and corrections',
