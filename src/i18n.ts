...
export const copy = {
  zh: {
    ...
    continueReading: '继续阅读', startReading: '开始阅读', bookStats: '9 章 · 7 个复盘日', bookOpenLabel: '翻开《期权墙》', bookHint: '点击翻开 · 继续阅读', bookInsideKicker: '期权墙 · 买方篇', bookInsideTitle: '从结构开始', bookInsideCta: '继续阅读 →',
  ...
  en: {
    ...
    continueReading: 'Continue reading', startReading: 'Start reading', bookStats: '9 chapters · 7 trade reviews', bookOpenLabel: 'Open Options Wall', bookHint: 'Click to open · Continue reading', bookInsideKicker: 'OPTIONS WALL · BUYER EDITION', bookInsideTitle: 'Begin with structure', bookInsideCta: 'Continue reading →',
    ...
    footerOne: 'Maimai · Personal trading notes and historical reviews', footerTwo: 'Options can expire worthless · Not investment advice', footerX: 'X · Updates', footerGithub: 'GitHub · Corrections', footerNav: 'Updates and corrections',
