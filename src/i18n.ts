...
export const copy = {
  zh: {
    ...
    footerOne: '麦麦 · 个人交易笔记与历史复盘', footerTwo: '期权有风险 · 不构成投资建议', pageViews: '已翻阅', pageViewUnit: '次', footerX: 'X · 更新', footerGithub: 'GitHub · 纠错', footerNav: '更新与纠错',
  ...
  en: {
    ...
    footerOne: 'Maimai · Personal trading notes and historical reviews', footerTwo: 'Options involve risk · Not investment advice', pageViews: 'Read', pageViewUnit: 'times', footerX: 'X · Updates', footerGithub: 'GitHub · Corrections', footerNav: 'Updates and corrections',
